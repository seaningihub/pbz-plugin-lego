...
typedef TSet<const class SLGATrackNode*> STrackNodeSelectionSet;

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class FLGATrackNodeDragDropOp : public FDragDropOperation
{
public:
	DRAG_DROP_OPERATOR_TYPE(FLGATrackNodeDragDropOp, FDragDropOperation)

	virtual void OnDrop(bool bDropWasHandled, const FPointerEvent& MouseEvent) override;

	virtual void OnDragged(const class FDragDropEvent& DragDropEvent) override;

	static TSharedRef<FLGATrackNodeDragDropOp> New(TSharedRef<SLGATrackNode> TrackNode, const FVector2D &CursorPosition, const FVector2D &ScreenPositionOfNode);
...
protected:
	...
	TWeakPtr<class SLGATrackNode>		OriginalTrackNode;
	TWeakPtr<class SLGATrack>			OriginalTrack;
	...
	friend class SLGATrack;
	friend class SLGATrackNode;
};

/** class STrackNode for STrack. 
 * This is Children for STrack
 */
class SLGATrackNode : public SCompoundWidget 
{
public:
	SLATE_BEGIN_ARGS(SLGATrackNode)
		: _ViewInputMin()
		, _ViewInputMax()
		, _DataLength()
		, _DataStartPos()
...
class SLGATrack : public SPanel
{
public:
	SLATE_BEGIN_ARGS(SLGATrack)
		: _ViewInputMin()
		, _ViewInputMax()
		, _TrackMaxValue()
		, _TrackMinValue()
	...
	void				AddTrackNode(TSharedRef<SLGATrackNode> Node);
	void				ClearTrack();
...
protected:
	...
	TSlotlessChildren< SLGATrackNode >			TrackNodes;
