...
class FLGATrackColorTracker
{
public:
	FLGATrackColorTracker()
		: CurrentColor(0)
	{
	}
...
class SLGA2ColumnWidget : public SCompoundWidget
{
public:
	...
	SLATE_BEGIN_ARGS( SLGA2ColumnWidget )
	{}
...
class SLGATimelineTrackPanel: public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS( SLGATimelineTrackPanel )
		: _ViewInputMin()
		, _ViewInputMax()
		, _InputMin()
		, _InputMax()
...
protected:
	...
	TSharedRef<class SLGA2ColumnWidget> Create2ColumnWidget( TSharedRef<SVerticalBox> Parent );	
