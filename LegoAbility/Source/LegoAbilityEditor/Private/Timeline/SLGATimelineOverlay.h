 ...
 */
class SLGATimelineOverlay : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS( SLGATimelineOverlay )
	...
	void Construct( const FArguments& InArgs, TSharedRef<FLGATimeSliderController> InTimeSliderController )
	{
