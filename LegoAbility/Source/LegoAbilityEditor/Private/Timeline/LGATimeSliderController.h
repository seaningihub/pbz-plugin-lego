 ...
 */
class FLGATimeSliderController : public ITimeSliderController
{
public:
	FLGATimeSliderController(const FTimeSliderArgs& InArgs, TWeakPtr<FLGATimelineModelBase> InWeakModel, TWeakPtr<SLGATimeline> InWeakTimeline, TSharedPtr<INumericTypeInterface<double>> InSecondaryNumericTypeInterface);
	...
	*/
	...
	virtual TRange<FFrameNumber> GetTimeBounds() const override;
...
private:
	...
	TWeakPtr<SLGATimeline> WeakTimeline;
