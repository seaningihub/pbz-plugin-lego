...
void SLGA2ColumnWidget::Construct(const FArguments& InArgs)
{
	this->ChildSlot
	[
		SNew( SBorder )
...
//////////////////////////////////////////////////////////////////////////
// SLGATimelineTrackPanel

void SLGATimelineTrackPanel::Construct(const FArguments& InArgs)
{
...
TSharedRef<class SLGA2ColumnWidget> SLGATimelineTrackPanel::Create2ColumnWidget( TSharedRef<SVerticalBox> Parent )
{
	TSharedPtr<SLGA2ColumnWidget> NewTrack;
	Parent->AddSlot()
		.AutoHeight()
		.VAlign(VAlign_Center)
		[
			SAssignNew (NewTrack, SLGA2ColumnWidget)
...
void SLGATimelineTrackPanel::PanInputViewRange(int32 ScreenDelta, FVector2D ScreenViewSize)
{
...
void SLGATimelineTrackPanel::InputViewRangeChanged(float ViewMin, float ViewMax)
{
